        ...
        <div class="col-md-offset-2 col-md-8">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form:form class="form-horizontal" modelAttribute="product" action="${contextRoot}/editor/product" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <form:select path="id" items="${categories}" itemLabel="name" itemValue="id" class="form-control"/>
